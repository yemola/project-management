...
// No need for TypeScript type declarations in JSX
export default function AddClientModal() {
  ...
  const [addClient] = useMutation(ADD_CLIENT, {
    ...
    update(cache, { data: { addClient } }) {
      const queryResult = cache.readQuery({ query: GET_CLIENTS });
  ...
  const handleSubmit = async (e) => {
    ...
    await addClient({ variables: { name, email, phone } });
...
//     variables: { name, email, phone },
//     update(cache, { data: { addClient } }) {
//       const queryResult = cache.readQuery<{ clients: Client[] }>({ query: GET_CLIENTS });
//       const clients = queryResult?.clients || [];
